...
// 파일 위치: src/renderer/src/assets/logos/{claude,codex,gemini}.png
...
export function GeminiLogo({ className }: LogoProps): React.JSX.Element {
  return <img src={geminiLogo} alt="" className={className} draggable={false} />
}
